<nav class="navbar navbar-expand-lg navbar-light bg-white bottom-shadow sticky-top">
    <a class="navbar-brand" href="#">
        <img src="<?php "PCD/" . $this->path('assets/images/ecomp/logoNome.png');?>" alt="" width="120" class="d-inline" id="logo1">
        <img src="<?php "PCD/" . $this->path('assets/images/ecomp/logo.png');?>" alt="" width="30" class="d-none" id="logo2">
    </a>
